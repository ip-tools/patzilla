...
Cut a new release
=================
This will package the javascript bundles, bump the version, push to git origin,
build a Python sdist package and upload it to PyPI. Some configuration steps
