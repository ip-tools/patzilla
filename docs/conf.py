# -*- coding: utf-8 -*-
#
# PatZilla documentation build configuration file, created by
...
project = u'PatZilla'
copyright = u'2013-2019, The PatZilla authors'
...
def setup(app):
    ...
    app.add_stylesheet("css/patzilla-documentation.css")
